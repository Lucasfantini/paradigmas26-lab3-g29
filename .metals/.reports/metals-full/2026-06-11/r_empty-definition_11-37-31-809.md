error id: file://<WORKSPACE>/src/main/scala/Main.scala:readSubscriptions.
file://<WORKSPACE>/src/main/scala/Main.scala
empty definition using pc, found symbol in pc: readSubscriptions.
...
non-local guesses:
	 ...
	 -FileIO.readSubscriptions#
	 -FileIO.readSubscriptions().
	 -scala/Predef.FileIO.readSubscriptions.
	 -scala/Predef.FileIO.readSubscriptions#
	 -scala/Predef.FileIO.readSubscriptions().
offset: 322
...
object Main {
  def main(args: Array[String]): Unit = {
    ...
    // Load subscriptions
    val subscriptionOpts = FileIO.readSub@@scriptions(cmdArgs.subscriptionFile)
